...
data_path = "G:\\Datasets&GP\\DEAP\\data_preprocessed_python\\convertedData\\\Frontal\\"
    #"G:\\Datasets&GP\\DEAP\\data_preprocessed_python\\convertedData\\Frontal\\"
...
def read_convert_outputCati(file_name,i):
    data = []
...
for per in range(1,33):
    ...
    Y0 = read_convert_outputCati('label0.csv',per)
    Y1 = read_convert_outputCati('label1.csv',per)
    print('Before reading data')

    X = read_input_datai(per)
    ...
    for i in range(12):
        ...
        for x in range (12):
            ...
            valence_models[i].fit(train_x0, Y0_train, epochs=10,batch_size=1)
            ...
            arousal_models[x].fit(train_x1, Y1_train, epochs=10,batch_size=1)
            print("______________________________________________________________________________________________________")
