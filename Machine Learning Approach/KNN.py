...
print('Accuracy KNN On Wavelet Transform Using db4: ', scr)
...
Model.fit(X_train, Y_train)
scr = Model.score(X_test, Y_test)
print('Accuracy KNN On Wavelet Transform Using db10 : ', scr)
predict_val = Model.predict(X_test)
Xno.clear()
...
Model.fit(X_train, Y_train)
scr = Model.score(X_test, Y_test)
print('Accuracy KNN On Wavelet Transform Using db4 and PSD : ', scr)
predict_val = Model.predict(X_test)
Xno.clear()
