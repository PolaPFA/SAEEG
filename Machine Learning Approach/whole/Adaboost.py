...
print('Accuracy Adaboost On Wavelet Transform Using db4 In Valence : ', scr)
X_train, X_test, Y_train, Y_test = train_test_split(Xno, Y, test_size=0.2,random_state=30)
Model = AdaBoostClassifier(DecisionTreeClassifier(max_depth=30), n_estimators=60)
Model.fit(X_train, Y_train)
scr = Model.score(X_test, Y_test)
print('Accuracy Adaboost On Wavelet Transform Using db4 In Arousal : ', scr)
Xno.clear()
...
Model.fit(X_train, Y_train)
scr = Model.score(X_test, Y_test)
print('Accuracy Adaboost On Wavelet Transform Using db10 In Valence : ', scr)
X_train, X_test, Y_train, Y_test = train_test_split(Xno, Y, test_size=0.2,random_state=30)
Model = AdaBoostClassifier(DecisionTreeClassifier(max_depth=150), n_estimators=150)
Model.fit(X_train, Y_train)
scr = Model.score(X_test, Y_test)
print('Accuracy Adaboost On Wavelet Transform Using db10 In Arousal : ', scr)
Xno.clear()
...
Model.fit(X_train, Y_train)
scr = Model.score(X_test, Y_test)
print('Accuracy Adaboost On Wavelet Transform Using db4 and PSD In Valence : ', scr)
X_train, X_test, Y_train, Y_test = train_test_split(Xno, Yno, test_size=0.2, random_state=30)
Model = AdaBoostClassifier(DecisionTreeClassifier(max_depth=100), n_estimators=100)
Model.fit(X_train, Y_train)
scr = Model.score(X_test, Y_test)
print('Accuracy Adaboost On Wavelet Transform Using db4 and PSD In Arousal : ', scr)
Xno.clear()
