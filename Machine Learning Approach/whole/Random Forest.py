...
with open(FeaturePath+"featureswithout.csv") as f:
    ...
    for row in reader:  # read a row as {column1: value1, column2: value2,...}
        ...
        temp = [float(i) for i in temp]
        Xno.append(temp)
X_train, X_test, Y_train, Y_test = train_test_split(Xno, Y, test_size=0.2,random_state=30)
Model = RandomForestClassifier(max_depth=100, random_state=0)
Model.fit(X_train, Y_train)
scr = Model.score(X_test, Y_test)
print('Accuracy Random Forest On Wavelet Transform Using db4 In Valence : ', scr)
X_train, X_test, Y_train, Y_test = train_test_split(Xno, Yno, test_size=0.2,random_state=30)
Model = RandomForestClassifier(max_depth=100, random_state=0)
Model.fit(X_train, Y_train)
scr = Model.score(X_test, Y_test)
print('Accuracy Random Forest On Wavelet Transform Using db4 In Arousal : ', scr)
Xno.clear()
...
Model.fit(X_train, Y_train)
scr = Model.score(X_test, Y_test)
print('Accuracy Random Forest On Wavelet Transform Using db10 In Valence : ', scr)
X_train, X_test, Y_train, Y_test = train_test_split(Xno, Yno, test_size=0.2,random_state=30)
Model = RandomForestClassifier(max_depth=100, random_state=0)
Model.fit(X_train, Y_train)
scr = Model.score(X_test, Y_test)
print('Accuracy Random Forest On Wavelet Transform Using db10 In Arousal : ', scr)
Xno.clear()
...
Model.fit(X_train, Y_train)
scr = Model.score(X_test, Y_test)
print('Accuracy Random Forest On Wavelet Transform Using db4 and PSD In Valence : ', scr)
X_train, X_test, Y_train, Y_test = train_test_split(Xno, Yno, test_size=0.2, random_state=30)
Model = RandomForestClassifier(max_depth=50, random_state=0)
Model.fit(X_train, Y_train)
scr = Model.score(X_test, Y_test)
print('Accuracy Random Forest On Wavelet Transform Using db4 and PSD In Arousal : ', scr)
Xno.clear()
